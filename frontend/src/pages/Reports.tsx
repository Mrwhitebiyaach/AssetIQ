      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl relative z-20">
        ...
        <CometCard>
          <div className="p-6 text-white">
            ...
            <button className="px-4 py-2 bg-red-600 rounded-lg text-white font-semibold">
              View Report
            </button>
          </div>
        </CometCard>
        ...
        <CometCard>
          <div className="p-6 text-white">
            ...
            <button className="px-4 py-2 bg-yellow-600 rounded-lg text-white font-semibold">
              View Report
            </button>
          </div>
        </CometCard>
        ...
        <CometCard>
          <div className="p-6 text-white">
            ...
            <button className="px-4 py-2 bg-purple-600 rounded-lg text-white font-semibold">
              View Report
            </button>
          </div>
        </CometCard>
